...
pub const Window = struct {
    ...
    pub fn setMinimumSize(self: Window, s: Size) !void {
    ...
    pub fn setMaximumSize(self: Window, s: Size) !void {
    ...
    pub fn getPosition(self: Window) Point {
    ...
    pub fn setTextInputArea(self: Window, rect: ?Region, offset_x: u32) !void {
