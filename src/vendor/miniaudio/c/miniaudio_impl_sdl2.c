...
ma_context *miniaudio_impl_sdl2_init_context()
{
    ma_result result;
    ma_context_config contextConfig;
    ma_context_ex *context = malloc(sizeof(ma_context_ex));
    ...
    return (ma_context *)context;
}
    
void miniaudio_impl_sdl2_uninit_context(ma_context *context)
{
