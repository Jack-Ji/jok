...
pub const zmesh = struct {
    const ZmeshFileOptions = jok.vendor.zmesh.io.zcgltf.FileOptions;
    const ZmeshMemoryOptions = jok.vendor.zmesh.io.zcgltf.MemoryOptions;
    const ZmeshResult = jok.vendor.zmesh.io.zcgltf.Result;
